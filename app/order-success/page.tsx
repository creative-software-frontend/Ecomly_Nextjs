...
import { Check, Printer, ShoppingBag, ArrowLeft, ChevronRight, ShoppingCart, MapPin, Pencil, MessageSquare, PhoneCall, Mail } from 'lucide-react'
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen pb-12 font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-4 border-b border-gray-50 flex justify-between items-center text-xs">
            ...
            <div className="flex justify-between items-center">
              ...
              >
                Create Shipping Label <ChevronRight size={14} />
              </button>
            </div>
      ...
      <div className="hidden print:block bg-white p-0 text-black font-sans overflow-hidden">
        ...
        <div style={{position:'relative',zIndex:10,padding:'1.75rem 2.5rem',display:'flex',flexDirection:'column',gap:'1rem'}}>
          {/* Header Title */}
